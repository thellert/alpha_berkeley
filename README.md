...
**🎉 Latest Release: v0.7.0** - Major architecture update! Framework is now pip-installable, enabling independent application development. See [Release Notes](RELEASE_NOTES.md) for details.
