...
""")
        ...
        assert any("missing critical communication capabilities" in record.message.lower()
                   for record in caplog.records if record.levelname == "WARNING")
...
""")
        ...
        assert any("failed to initialize" in record.message.lower()
                   for record in caplog.records if record.levelname == "WARNING")
...
""")
        ...
        assert any("failed to initialize capability" in record.message.lower()
                   for record in caplog.records if record.levelname == "WARNING")
